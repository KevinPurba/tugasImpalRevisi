...
<script type="text/javascript" src="js/rightde.js"></script>
<title>Klinik Aliyah Medika</title>
</head>
...
<h1 class="text-center ">Klinik Aliyah Medika<br /><small style="font-size:20px">Clinic Management System</small></h1>
</div>
</div>
</div>
<br />
...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>Silahkan login untuk menggunakan sistem ini.  klik <a target="_blank" style="font-colour="Blue"" href='superadmin.php'> Register </a> untuk membuat user baru
<br>
...
Klinik Aliyah Medika, Jalan Sukabirus, Bandung.
        </div>
    </div>
    </div>
	</footer>
