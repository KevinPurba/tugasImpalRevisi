...
<tr>
    ...
    <td align="center">Rp. <?php echo $row["doc_charge"]; ?> </td>
    <td align="center">Rp. <?php echo $row["medi_charge"]; ?> </td>
    <td align="center">Rp. <?php echo $row["hos_charge"]; ?> </td>
    <td align="center">Rp. <?php echo $row["total_charge"]; ?></td>
